    ...
    var body: some View {
        VStack {
            ...
            .alert(isPresented: $alertsIsVisible, content:{
                ...
                return Alert(title:Text("Hello there!"),message: Text("The slider value is \(self.sliderValue), rounded value is \(roundedValue)"), dismissButton: .default(Text("Awesome!")))
            })
        }
    }
}
